...
[![Open in Visual Studio Code](https://classroom.github.com/assets/open-in-vscode-2e0aaae1b6195c2367325f4f02e2d04e9abb55f0b24a779b69b11b9e10269abc.svg)](https://classroom.github.com/online_ide?assignment_repo_id=19167391&assignment_repo_type=AssignmentRepo)
...
- [done ] `index.html` with complete structure
- [done ] `form.html` with inputs and validation
- [ done] `style.css` applied correctly
- [done ] Responsive behavior tested
- [done ] Bootstrap components integrated
- [ ---] Sass code (optional)
